...
public class Cola<T> {
    ...
    /**
     * Verifica si los elementos dentro de las colas sean iguales
     * 
     */
    public boolean sonIdenticas(Cola<T> otraCola) {
    /** 
    ...
    /** 
     * Si ambas están vacías, son idénticas
     */
    if (this.isEmpty() && otraCola.isEmpty()) {
        return true;
    }
    
    /**
     * Crear punteros temporales para recorrer ambas colas
     */
    Nodo<T> temp1 = this.cabeza;
    Nodo<T> temp2 = otraCola.cabeza;
    ...
    while (temp1 != null && temp2 != null) {
        /** 
         * Comparar los datos de los nodos actuales
         */
        if (!temp1.getDato().equals(temp2.getDato())) {
            return false;
        }
        /**
    ...
    /**
     * Todas las comparaciones fueron exitosas
     */
    return true;
    }   
